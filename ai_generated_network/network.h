...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "yunetn_320"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x28cbcb2715420c9ce9d9e3b61204a6be"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x6251e05e2e5d57c8)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,3,320,320}
...
#define STAI_NETWORK_OUT_NUM             (12)
#define STAI_NETWORK_OUT_SIZE_BYTES      (134404)
#define STAI_NETWORK_OUT_ALIGNMENTS \
  { 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}
#define STAI_NETWORK_OUT_NAMES \
  { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL}
#define STAI_NETWORK_OUT_FORMATS \
  { STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32, STAI_FORMAT_FLOAT32}
#define STAI_NETWORK_OUT_SIZES \
  { 1600, 400, 100, 1600, 400, 100, 6400, 1600, 400, 16000, 4000, 1000}
#define STAI_NETWORK_OUT_SIZES_BYTES \
  {6400,1600,400,6400,1600,400,25600,6400,1600,64000,16000,4000}
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,1600,1}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (1600)
#define STAI_NETWORK_OUT_1_HEIGHT      (1)
#define STAI_NETWORK_OUT_1_RANK        (2)
#define STAI_NETWORK_OUT_1_SIZE        ((1 * 1600))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (6400)

#define STAI_NETWORK_OUT_2_ALIGNMENT   4
#define STAI_NETWORK_OUT_2_NAME        (NULL)
#define STAI_NETWORK_OUT_2_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_2_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_2_SHAPE       {1,400,1}
#define STAI_NETWORK_OUT_2_BATCH       (1)
#define STAI_NETWORK_OUT_2_CHANNEL     (400)
#define STAI_NETWORK_OUT_2_HEIGHT      (1)
#define STAI_NETWORK_OUT_2_RANK        (2)
#define STAI_NETWORK_OUT_2_SIZE        ((1 * 400))
#define STAI_NETWORK_OUT_2_SIZE_BYTES  (1600)

#define STAI_NETWORK_OUT_3_ALIGNMENT   4
#define STAI_NETWORK_OUT_3_NAME        (NULL)
#define STAI_NETWORK_OUT_3_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_3_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_3_SHAPE       {1,100,1}
#define STAI_NETWORK_OUT_3_BATCH       (1)
#define STAI_NETWORK_OUT_3_CHANNEL     (100)
#define STAI_NETWORK_OUT_3_HEIGHT      (1)
#define STAI_NETWORK_OUT_3_RANK        (2)
#define STAI_NETWORK_OUT_3_SIZE        ((1 * 100))
#define STAI_NETWORK_OUT_3_SIZE_BYTES  (400)

#define STAI_NETWORK_OUT_4_ALIGNMENT   4
#define STAI_NETWORK_OUT_4_NAME        (NULL)
#define STAI_NETWORK_OUT_4_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_4_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_4_SHAPE       {1,1600,1}
#define STAI_NETWORK_OUT_4_BATCH       (1)
#define STAI_NETWORK_OUT_4_CHANNEL     (1600)
#define STAI_NETWORK_OUT_4_HEIGHT      (1)
#define STAI_NETWORK_OUT_4_RANK        (2)
#define STAI_NETWORK_OUT_4_SIZE        ((1 * 1600))
#define STAI_NETWORK_OUT_4_SIZE_BYTES  (6400)

#define STAI_NETWORK_OUT_5_ALIGNMENT   4
#define STAI_NETWORK_OUT_5_NAME        (NULL)
#define STAI_NETWORK_OUT_5_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_5_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_5_SHAPE       {1,400,1}
#define STAI_NETWORK_OUT_5_BATCH       (1)
#define STAI_NETWORK_OUT_5_CHANNEL     (400)
#define STAI_NETWORK_OUT_5_HEIGHT      (1)
#define STAI_NETWORK_OUT_5_RANK        (2)
#define STAI_NETWORK_OUT_5_SIZE        ((1 * 400))
#define STAI_NETWORK_OUT_5_SIZE_BYTES  (1600)

#define STAI_NETWORK_OUT_6_ALIGNMENT   4
#define STAI_NETWORK_OUT_6_NAME        (NULL)
#define STAI_NETWORK_OUT_6_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_6_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_6_SHAPE       {1,100,1}
#define STAI_NETWORK_OUT_6_BATCH       (1)
#define STAI_NETWORK_OUT_6_CHANNEL     (100)
#define STAI_NETWORK_OUT_6_HEIGHT      (1)
#define STAI_NETWORK_OUT_6_RANK        (2)
#define STAI_NETWORK_OUT_6_SIZE        ((1 * 100))
#define STAI_NETWORK_OUT_6_SIZE_BYTES  (400)

#define STAI_NETWORK_OUT_7_ALIGNMENT   4
#define STAI_NETWORK_OUT_7_NAME        (NULL)
#define STAI_NETWORK_OUT_7_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_7_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_7_SHAPE       {1,4,40,40}
#define STAI_NETWORK_OUT_7_BATCH       (1)
#define STAI_NETWORK_OUT_7_CHANNEL     (4)
#define STAI_NETWORK_OUT_7_HEIGHT      (40)
#define STAI_NETWORK_OUT_7_WIDTH       (40)
#define STAI_NETWORK_OUT_7_RANK        (3)
#define STAI_NETWORK_OUT_7_SIZE        ((4 * 40 * 40))
#define STAI_NETWORK_OUT_7_SIZE_BYTES  (25600)

#define STAI_NETWORK_OUT_8_ALIGNMENT   4
#define STAI_NETWORK_OUT_8_NAME        (NULL)
#define STAI_NETWORK_OUT_8_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_8_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_8_SHAPE       {1,4,20,20}
#define STAI_NETWORK_OUT_8_BATCH       (1)
#define STAI_NETWORK_OUT_8_CHANNEL     (4)
#define STAI_NETWORK_OUT_8_HEIGHT      (20)
#define STAI_NETWORK_OUT_8_WIDTH       (20)
#define STAI_NETWORK_OUT_8_RANK        (3)
#define STAI_NETWORK_OUT_8_SIZE        ((4 * 20 * 20))
#define STAI_NETWORK_OUT_8_SIZE_BYTES  (6400)

#define STAI_NETWORK_OUT_9_ALIGNMENT   4
#define STAI_NETWORK_OUT_9_NAME        (NULL)
#define STAI_NETWORK_OUT_9_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_9_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_9_SHAPE       {1,4,10,10}
#define STAI_NETWORK_OUT_9_BATCH       (1)
#define STAI_NETWORK_OUT_9_CHANNEL     (4)
#define STAI_NETWORK_OUT_9_HEIGHT      (10)
#define STAI_NETWORK_OUT_9_WIDTH       (10)
#define STAI_NETWORK_OUT_9_RANK        (3)
#define STAI_NETWORK_OUT_9_SIZE        ((4 * 10 * 10))
#define STAI_NETWORK_OUT_9_SIZE_BYTES  (1600)

#define STAI_NETWORK_OUT_10_ALIGNMENT   4
#define STAI_NETWORK_OUT_10_NAME        (NULL)
#define STAI_NETWORK_OUT_10_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_10_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_10_SHAPE       {1,10,40,40}
#define STAI_NETWORK_OUT_10_BATCH       (1)
#define STAI_NETWORK_OUT_10_CHANNEL     (10)
#define STAI_NETWORK_OUT_10_HEIGHT      (40)
#define STAI_NETWORK_OUT_10_WIDTH       (40)
#define STAI_NETWORK_OUT_10_RANK        (3)
#define STAI_NETWORK_OUT_10_SIZE        ((10 * 40 * 40))
#define STAI_NETWORK_OUT_10_SIZE_BYTES  (64000)

#define STAI_NETWORK_OUT_11_ALIGNMENT   4
#define STAI_NETWORK_OUT_11_NAME        (NULL)
#define STAI_NETWORK_OUT_11_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_11_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_11_SHAPE       {1,10,20,20}
#define STAI_NETWORK_OUT_11_BATCH       (1)
#define STAI_NETWORK_OUT_11_CHANNEL     (10)
#define STAI_NETWORK_OUT_11_HEIGHT      (20)
#define STAI_NETWORK_OUT_11_WIDTH       (20)
#define STAI_NETWORK_OUT_11_RANK        (3)
#define STAI_NETWORK_OUT_11_SIZE        ((10 * 20 * 20))
#define STAI_NETWORK_OUT_11_SIZE_BYTES  (16000)

#define STAI_NETWORK_OUT_12_ALIGNMENT   4
#define STAI_NETWORK_OUT_12_NAME        (NULL)
#define STAI_NETWORK_OUT_12_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_12_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_12_SHAPE       {1,10,10,10}
#define STAI_NETWORK_OUT_12_BATCH       (1)
#define STAI_NETWORK_OUT_12_CHANNEL     (10)
#define STAI_NETWORK_OUT_12_HEIGHT      (10)
#define STAI_NETWORK_OUT_12_WIDTH       (10)
#define STAI_NETWORK_OUT_12_RANK        (3)
#define STAI_NETWORK_OUT_12_SIZE        ((10 * 10 * 10))
#define STAI_NETWORK_OUT_12_SIZE_BYTES  (4000)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (2517164)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (2517164)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (59564)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (59564)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
#define STAI_NETWORK_ACTIVATION_2_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_NETWORK_ACTIVATION_2_SIZE       (2457600)
#define STAI_NETWORK_ACTIVATION_2_SIZE_BYTES (2457600)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (295360)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (295360)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (295360)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (295360)
